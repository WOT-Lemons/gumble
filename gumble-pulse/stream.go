package gumble-pulse // import "github.com/TLMcNulty/gumble/gumble-pulse"
...
var (
	ErrState = errors.New("gumble-pulse: invalid state")
)

//Try to print a list of pulse devices here at some point
